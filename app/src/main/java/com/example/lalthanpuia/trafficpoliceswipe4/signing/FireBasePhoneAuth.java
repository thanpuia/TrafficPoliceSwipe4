...
public class FireBasePhoneAuth extends AppCompatActivity implements
    ...
    public void onClick(View view) {
       ...
       /* citizenName = findViewById(R.id.citizenName);
        citizenAddress = findViewById(R.id.citizenAddress);
        citizenPhone = findViewById(R.id.citizenPhone);
        citizenDOB = findViewById(R.id.citizenDOB);
      ...
      //  signUpButton =findViewById(R.id.signUpButton);
        ...
        citizenRole = findViewById(R.id.citizenRole);
        ...
        citizenRole.setAdapter( adapter );
    ...
    public void GoogleSignUpClick(View view) {
        ...
        tempUserAddress = citizenAddress.getText().toString();
        tempUserPhone = citizenPhone.getText().toString();
        tempUserDOB = citizenDOB.getText().toString();
        ...
        tempUserRole = citizenRole.getSelectedItem().toString();

        switch (tempUserRole){
            case "Citizen"          :database = FirebaseDatabase.getInstance().getReference("user_details");break;
            case "Police"           :database = FirebaseDatabase.getInstance().getReference("police_details");break;
            case "Administrator"    :database = FirebaseDatabase.getInstance().getReference("admin_details");break;
        }


        };
        // 1. IF PASSWORD MATCH
     *//*   if(tempUserName.isEmpty() || tempUserAddress.isEmpty() || tempUserPhone.isEmpty() || tempUserDOB.isEmpty() || tempUserEmail.isEmpty() || tempUserPassword.isEmpty() || tempUserConfirmPassword.isEmpty() || tempUserRole.isEmpty()){
   ...
   public void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(FireBasePhoneAuth.this);
    ...
    private void updateUI(FirebaseUser currentUser) {
        ...
        if(currentUser!=null){
            ...
            userDetails.setAddress(tempUserAddress);
            userDetails.setPhone(tempUserPhone);
            userDetails.setDob(tempUserDOB);
            userDetails.setEmail(tempUserEmail);
            userDetails.setPassword(tempUserPassword);
            userDetails.setRole(tempUserRole);
            ...
            database.child(newKey).setValue(userDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    citizenName .setText("");
                    citizenAddress.setText("");
                    citizenPhone .setText("");
                    citizenDOB .setText("");
                    citizenEmail .setText("");
                    citizenPassword .setText("");
                    citizenConfirmPassword .setText("");
                    dismissProgressDialog();
                    Toasty.success(getApplicationContext(),"GoogleSignUp Successful",Toasty.LENGTH_SHORT).show();
                }
            });
